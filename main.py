...
# =========================
# PROSES BALAS ADMIN (PRODUCTION SAFE)
# =========================
    ...
    try:
        sheet_main.update(
            ...
            [[
                balasan,          # E Balasan
                kode,             # F Kode
                admin_display,    # G Admin
                row[7],           # H Alamat
                "Replied",        # I Status
                "",               # J Locked_by dikosongkan
